    ...
    >
      ...
      <div className="relative z-10 max-w-max mx-auto text-white">
        ...
        <button 
          ...
          className="bg-white font-poppins font-bold text-black py-4 px-5 rounded-2xl hover:bg-yellow active:bg-yellow active:text-white text-2xl shadow-2xl stroke-zinc-200 stroke-2" onClick={()=>{location.href="/products"}}>
          Get Started Now
        </button>
      </div>
    </section>
