    ...
    >
      ...
      <div className="relative z-10 max-w-max mx-auto text-white">
        <h1 className="text-8xl md:text-8xl font-bold mb-4 font-poppins">
          Tired of <span className="text-yellow "> Queues?</span> <br/> We sure are!
        </h1>
        <p className="text-lg md:text-xl mb-6 font-inter leading-3 font-medium">
          That is the exact reason we are doing this! See for yourself,<br/> experience, interact, and explore the goodness of the time you <br/> just saved by ordering with this website.
        </p>
